            ...
            <>
              <div className="mb-8">
                <div className="flex items-center justify-between mb-4">
                  <span className="text-sm font-medium text-teal-600">問題 {getCurrentQuestionNumber()}</span>
                  <span className="text-sm text-cream-500">其他需求評估</span>
                </div>
                <div className="w-full bg-cream-300 rounded-full h-2 mb-6">
                  <div className="bg-teal-600 h-2 rounded-full" style={{ width: `${getProgressPercentage()}%` }}></div>
                </div>
                    ...
                    <button
                      ...
                      className={`w-full p-4 rounded-lg border-2 text-left transition-all cursor-pointer ${
                        insuranceKnowledge === option.value
                          ? 'border-teal-600 bg-cream-100 text-teal-700'
                    ...
                    >
                      <div className="flex items-center">
                        <div className={`w-6 h-6 rounded-full border-2 mr-4 flex items-center justify-center flex-shrink-0 ${
                          insuranceKnowledge === option.value ? 'border-teal-600 bg-teal-600' : 'border-cream-300'
                        }`}>
                          {insuranceKnowledge === option.value && (
              ...
              <div className="flex justify-between mt-8">
                ...
                <button
                  ...
                  className="px-8 py-3 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-colors font-medium whitespace-nowrap cursor-pointer disabled:bg-cream-300 disabled:cursor-not-allowed"
                >
                  下一步
                    ...
                    <button
                      ...
                      className={`w-full text-left px-6 py-4 rounded-lg border-2 transition-all cursor-pointer ${
                        policyCheckExpectations.includes(option.value)
                          ...
                          : 'border-cream-300 hover:border-emerald-300'
                      }`}
                    >
                      <div className="flex items-center">
                        ...
                        <span className="font-medium text-cream-900">{option.label}</span>
                      </div>
                    </button>
                  ))}
                </div>
