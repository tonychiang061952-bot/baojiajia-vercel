        ...
        <div className="p-8 lg:p-12 flex flex-col">
          {currentStep === 1 ? (
            <>
              <div className="mb-8">
                <div className="flex items-center justify-between mb-4">
                  <span className="text-sm font-medium text-teal-600">問題 1/2</span>
                  <span className="text-sm text-cream-500">壽險需求評估</span>
                </div>
                ...
                <div className="mb-8">
                  ...
                  <div className="relative">
                    <input
                      ...
                      placeholder="例如：500"
                      className="w-full px-6 py-4 text-2xl border-2 border-cream-300 rounded-lg focus:border-blue-600 focus:outline-none transition-colors"
                    />
                    <span className="absolute right-6 top-1/2 -translate-y-1/2 text-xl text-cream-500">
                      萬
                    </span>
                  </div>
              ...
              <div className="flex justify-between mt-8">
                ...
                <button
                  ...
                  className="px-8 py-3 bg-teal-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium whitespace-nowrap cursor-pointer disabled:bg-cream-300 disabled:cursor-not-allowed"
                >
                  下一步
            ...
            <>
              <div className="mb-8">
                <div className="flex items-center justify-between mb-4">
                  <span className="text-sm font-medium text-teal-600">問題 2/2</span>
                  <span className="text-sm text-cream-500">壽險需求評估</span>
                </div>
                <div className="w-full bg-cream-300 rounded-full h-2 mb-6">
