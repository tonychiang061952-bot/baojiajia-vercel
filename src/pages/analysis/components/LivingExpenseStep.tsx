            ...
            <div className="bg-white rounded-lg p-6">
              ...
              <ul className="space-y-3 text-sm text-cream-600">
                <li className="flex items-start">
                  <i className="ri-home-4-line text-teal-600 mr-2 mt-0.5"></i>
                  <span>房租或房貸</span>
                </li>
                <li className="flex items-start">
                  <i className="ri-lightbulb-line text-teal-600 mr-2 mt-0.5"></i>
                  <span>水電瓦斯等公用事業費</span>
                </li>
                <li className="flex items-start">
                  <i className="ri-bank-card-line text-teal-600 mr-2 mt-0.5"></i>
                  <span>貸款費用</span>
                </li>
                <li className="flex items-start">
                  <i className="ri-car-line text-teal-600 mr-2 mt-0.5"></i>
                  <span>交通費用</span>
                </li>
                <li className="flex items-start">
                  <i className="ri-shopping-cart-line text-teal-600 mr-2 mt-0.5"></i>
                  <span>家庭日常開銷</span>
                </li>
              </ul>
            </div>
        ...
        <div className="p-8 lg:p-12 flex flex-col">
          <div className="mb-8">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-sm text-cream-500">重症需求評估</span>
            </div>
            <div className="w-full bg-cream-300 rounded-full h-2 mb-6">
              <div className="bg-teal-600 h-2 rounded-full" style={{ width: '66.66%' }}></div>
            </div>
