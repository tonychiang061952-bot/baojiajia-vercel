      ...
      <div className="min-h-screen bg-cream-100 py-8">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-lg p-6 mb-6">
            <h2 className="text-2xl font-bold text-cream-900 mb-6">編輯特色項目</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature) => (
            <div key={feature.id} className="bg-white rounded-lg p-6">
              <div className="flex items-start justify-between mb-4">
                ...
                >
                  {feature.is_active ? (
                    ...
                    <span className="inline-flex items-center gap-1 px-3 py-1 bg-cream-200 text-cream-600 rounded-full text-xs font-medium whitespace-nowrap">
              ...
              <h3 className="text-xl font-bold text-cream-900 mb-2">{feature.title}</h3>
              <p className="text-sm text-cream-600 mb-4 line-clamp-3">{feature.description}</p>
